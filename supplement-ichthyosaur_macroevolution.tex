...
\makeatletter 
    \renewcommand{\thefigure}{\textallsc{S}\@arabic\c@figure}
    \renewcommand{\thetable}{\textallsc{S}\@arabic\c@table}
...
% FIXME: remove the diversity bit?
...
% \begin{figure} \caption[Rates of continuous skull length evolution in
% Ichthyosauriformes]{(following pages) \textbf{Rates of continuous skull length
% evolution in Ichthyosauriformes.} Consensus trees of variable rates model on
% 100 time-scaled trees in BayesTraits using ichthyosauriform skull length data.
% Branch lengths are shown both rescaled from the rate of continuous character
% evolution and replaced by these rates also.} \end{figure} \FloatBarrier
% 
% \includepdf[pages = -, fitpaper = true]{supp_figures/figS9-bayestraits_consensus_trees.pdf}
% \FloatBarrier
% 
% \begin{figure}
